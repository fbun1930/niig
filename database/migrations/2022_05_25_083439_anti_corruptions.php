...
class AntiCorruptions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('anti_corruptions', function (Blueprint $table) {
            $table->integer('id')->autoIncrement()->unique();
            $table->integer('category_file_corruption_id')->nullable()->comment('Категория файлов по анти-коррупции');
    ...
    {
        Schema::dropIfExists('anti_corruptions');
    }
}
