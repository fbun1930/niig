...
class AdvertResultCompetitions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('advert_result_competitions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('advert_result_competitions');
    }
}
