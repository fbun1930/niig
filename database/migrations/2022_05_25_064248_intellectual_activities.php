...
class IntellectualActivities extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('intellectual_activities', function (Blueprint $table) {
            $table->integer('id')->autoIncrement()->unique();
            $table->integer('category_intellectual_activity_id')->nullable()->comment('Категория интеллектуальной деятельности');
    ...
    {
        Schema::dropIfExists('intellectual_activities');
    }
}
